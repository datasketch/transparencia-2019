...
%\begin{abstract}
\color{colT}{\justify{2003, Barranbermeja, Santander, Corrupción Política, Condena Alcalde}}
%\end{abstract}
...
\begin{ejbi-colone}DELITO\end{ejbi-colone} &
 \begin{ejbi-coltwo}Concierto para delinquir.\end{ejbi-coltwo}\\ 
\colrul
\addlinespace
...
\multicolumn{1}{c !{\color{colfich}\vline}}{{\begin{tabular}{@{}c@{}}
 ...
 \\
 \multicolumn{1}{c !{\color{colfich}\vline}}{{\begin{ejbi-coltwo} \parbox[t]{3.4cm}{\begin{center}Alcalde\end{center}}\end{ejbi-coltwo}}}  & \multicolumn{1}{c}{\begin{ejbi-coltwo}\parbox[t]{3.4cm}{\begin{center} Capturado\end{center}} \end{ejbi-coltwo}} \\ \arrayrulecolor{colfich}\hline
\end{tabular}
\end{tabular}
...
%  \begin{ejbi-coltwo} SANTANDER - BARRANCABERMEJA \end{ejbi-coltwo}\\ 
% \colrul 
%  \begin{ejbi-coltwo} 2003 \end{ejbi-coltwo}  & \begin{ejbi-coltwo} FECHA DE INICIO \end{ejbi-coltwo} \\
% \colrul 
% \specialcell[]{\begin{ejbi-colone}ACTOR O ENTIDAD \end{ejbi-colone} \\
...
% \multicolumn{1}{c}{\begin{ejbi-colone}ESTADO JUDICIAL:\end{ejbi-colone}} 
% \\
% \multicolumn{1}{c !{\color{colfich}\vline}}{{\begin{ejbi-coltwo} \parbox[t]{4cm}{\begin{center}Alcalde\end{center}}\end{ejbi-coltwo}}}  & \multicolumn{1}{c}{\begin{ejbi-coltwo}\parbox[t]{4cm}{\begin{center} Capturado\end{center}} \end{ejbi-coltwo}} \\ \arrayrulecolor{colfich}\hline
%         \end{tabular}
%     \end{table}